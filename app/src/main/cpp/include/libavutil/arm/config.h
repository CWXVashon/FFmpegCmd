...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=/home/vashon/android/src/ffmpeg-4.4/android/armeabi-v7a --arch=arm --cpu=armv7-a --sysroot=/home/vashon/android/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/sysroot --enable-cross-compile --enable-neon --enable-hwaccels --enable-asm --enable-small --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-postproc --enable-network --enable-bsfs --enable-postproc --enable-filters --enable-encoders --enable-gpl --enable-muxers --enable-parsers --enable-protocols --enable-jni --enable-mediacodec --enable-libx264 --enable-decoder='mjpeg,mpeg4,h263,h264,flv,hevc,wmv3,msmpeg4v3,msmpeg4v2,msvideo1,vc1,mpeg1video,mpeg2video,aac,ac3,ac3_fixed,m4a,amrnb,amrwb,vorbis,wmav2,truehd,tscc,tscc2,dvvideo,msrle,cinepak,indeo5,vp8,vp9,mp3float,mp3,mp3adufloat,mp3adu,mp3on4float,mp3on4,aac_fixed,aac_latm,eac3,png,wmav1,wmv1,wmv2,pcm_alaw,pcm_dvd,pcm_f16le,pcm_f24le,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,zlib,flac,opus,mlp,pcm_s16be,pcm_s16le,pcm_s24be,pcm_s24le,pcm_s32be,pcm_s32le,pcm_s64be,pcm_s64le,pcm_mulaw,alac,adpcm_ms,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_vidc,pcm_zork,adpcm_ima_qt,adpcm_ima_wav,gif,hevc_mediacodec,mpeg4_mediacodec,vp9_mediacodec,decoder=h264_mediacodec' --enable-demuxer='aac,ac3,alaw,amr,amrnb,amrwb,ape,asf,asf_o,avi,cavsvideo,codec2,concat,dnxhd,eac3,flac,flv,gif,gif_pipe,h263,h264,hevc,hls,image2,image2pipe,jpeg_pipe,lrc,m4v,matroska,webm,mjpeg,mov,mp4,m4a,3gp,mp3,mpeg,mpegts,mv,ogg,png_pipe,realtext,rm,rtp,rtsp,pcm_s16be,pcm_s16le,pcm_s32be,pcm_s32le,sdp,srt,swf,vc1,wav,webm_dash,manifest,xmv,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,mpegvideo,mulaw,sami,srt' --enable-static --disable-shared --disable-doc --disable-avdevice --disable-avresample --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --disable-symver --disable-indevs --disable-outdevs --disable-decoders --disable-demuxers --extra-cflags='-Os -fpic -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb -I/home/vashon/android/src/ffmpeg-4.4/android/armeabi-v7a/include -I/home/vashon/android/src/ffmpeg-4.4/android/libx264/armeabi-v7a/include' --extra-ldflags='-lc -ldl -lm -lz -llog -lgcc -L/home/vashon/android/src/ffmpeg-4.4/android/armeabi-v7a/lib -L/home/vashon/android/src/ffmpeg-4.4/android/libx264/armeabi-v7a/lib' --cc=/home/vashon/android/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang --cxx=/home/vashon/android/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang++ --cross-prefix=/home/vashon/android/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/arm-linux-androideabi-"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/home/vashon/android/src/ffmpeg-4.4/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/home/vashon/android/src/ffmpeg-4.4/android/armeabi-v7a/share/ffmpeg"
